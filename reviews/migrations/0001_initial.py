    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost_perfomance', models.IntegerField(validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)])),
            ],
            options={
                'db_table': 'reviews',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviewimages', to='reviews.review')),
            ],
        ),
    ]
